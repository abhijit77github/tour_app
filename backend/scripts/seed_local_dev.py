...
OPERATOR_PROFILES = [
    {
        ...
        "specializations": ["City Tours", "Heritage Walks", "Food Walks"],
        "average_rating": 4.5,
        "total_reviews": 10,
        "serving_areas": [
            {
            ...
            },
            {
                ...
                "state": "Uttar Pradesh",
                "country": "India",
                "description": "Mughal heritage city anchored by the Taj Mahal and Agra Fort",
                "images": [],
                "coordinates": {"latitude": 27.18, "longitude": 78.02},
                "sub_locations": [],
            },
            {
                "area_name": "Jaipur",
                "state": "Rajasthan",
                "country": "India",
                "description": "Pink City heritage base with forts, palaces, and observatory landmarks",
                "images": [],
                "coordinates": {"latitude": 26.915, "longitude": 75.82},
                "sub_locations": [],
            },
            {
                "area_name": "Udaipur",
                "state": "Rajasthan",
                "country": "India",
                "description": "Mewar heritage city organized around palace and lake circuits",
                "images": [],
                "coordinates": {"latitude": 24.58, "longitude": 73.68},
                "sub_locations": [],
            },
            {
                "area_name": "Jodhpur",
                "state": "Rajasthan",
                "country": "India",
                "description": "Marwar fort city on the Thar edge with strong old-city heritage appeal",
                "images": [],
                "coordinates": {"latitude": 26.28, "longitude": 73.02},
                "sub_locations": [],
            },
            {
                "area_name": "Jaisalmer",
                "state": "Rajasthan",
                "country": "India",
                "description": "Fort town and desert-edge tourism hub in western Rajasthan",
                "images": [],
                "coordinates": {"latitude": 26.913, "longitude": 70.915},
                "sub_locations": [],
            },
            {
                "area_name": "Varanasi",
                "state": "Uttar Pradesh",
                "country": "India",
                "description": "Sacred Ganges city combining ghats, temples, and the Sarnath extension",
                "images": [],
            ...
            },
            {
                ...
                "state": "Punjab",
                "country": "India",
                "description": "Punjab heritage city centered on the Golden Temple precinct",
                "images": [],
                "coordinates": {"latitude": 31.64, "longitude": 74.86},
                "sub_locations": [],
            },
            {
                "area_name": "Khajuraho",
                ...
                "country": "India",
                "description": "Temple-focused heritage destination built around the Khajuraho monument groups",
                "images": [],
                "coordinates": {"latitude": 24.85, "longitude": 79.92},
                "sub_locations": [],
            },
        ],
    },
    {
        ...
        "specializations": ["Trekking", "Family Trips", "Road Trips", "Hill Stations", "Wildlife"],
        "average_rating": 4.7,
        "total_reviews": 35,
        "serving_areas": [
            {
            ...
            {
                "area_name": "Darjeeling",
                "state": "West Bengal",
                "country": "India",
                "description": "Highland tea town with spring and autumn tourism peaks",
                "images": [],
                "coordinates": {"latitude": 27.0375, "longitude": 88.263},
                "sub_locations": [],
            },
            {
                "area_name": "Gangtok",
                "state": "Sikkim",
                "country": "India",
                "description": "Sikkim capital base for monastery circuits and mountain views",
                "images": [],
                "coordinates": {"latitude": 27.33, "longitude": 88.62},
                "sub_locations": [],
            },
            {
                "area_name": "Shillong",
                "state": "Meghalaya",
                "country": "India",
                "description": "Meghalaya plateau city with waterfalls, peaks, and lake approaches",
                "images": [],
                "coordinates": {"latitude": 25.5822, "longitude": 91.8933},
                "sub_locations": [],
            },
            {
                ...
                "state": "Assam",
                "country": "India",
                "description": "Assam wildlife destination structured around safari ranges and flood-sensitive seasonality",
                "images": [],
                "coordinates": {"latitude": 26.6667, "longitude": 93.35},
                "sub_locations": [],
            },
        ],
    },
    {
        ...
        "specializations": ["Beaches", "Water Sports", "Food Tours", "Coastal Heritage"],
        "average_rating": 4.6,
        "total_reviews": 22,
        "serving_areas": [
            {
            ...
            },
            {
                ...
                "state": "Odisha",
                "country": "India",
                "description": "Temple-and-beach destination on the Bay of Bengal coast",
                "images": [],
                "coordinates": {"latitude": 19.8106, "longitude": 85.8314},
                "sub_locations": [],
            },
            {
                "area_name": "Konark",
                "state": "Odisha",
                "country": "India",
                "description": "Sun Temple heritage town linked to the Odisha coast and Puri corridor",
                "images": [],
                "coordinates": {"latitude": 19.8908, "longitude": 86.1003},
                "sub_locations": [],
            },
        ],
    },
