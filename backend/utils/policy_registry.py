...
POLICY_RULES: tuple[PolicyRule, ...] = (
    ...
    PolicyRule("admin", "GET", "/admin/billing/roi-baseline", "admin.billing.manage"),
    PolicyRule("admin", "POST", "/admin/billing/roi-baseline", "admin.billing.manage"),
    PolicyRule("admin", "*", "/admin/billing/roi-baseline/history", "admin.billing.read"),
